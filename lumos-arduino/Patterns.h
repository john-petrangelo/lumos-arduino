...
class Patterns {
  public:
    ...
    static void setGradient(int firstPixel, int lastPixel, int count, ...);
    static void setSolidColor(int firstPixel, int lastPixel, Color color);
    static void setSolidColor(Color color) { setSolidColor(0, strip.numPixels(), color); }
};
